package com.valley.yojbackendmodel.model.entity;
...
public class Question implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getSubmitNumb() == null ? other.getSubmitNumb() == null : this.getSubmitNumb().equals(other.getSubmitNumb()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSubmitNumb() == null) ? 0 : getSubmitNumb().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", submitNumb=").append(submitNumb);
